                ...
                <div class="input_group">
                    <div class="input_container " >
                        <div class="input " id="input_username" >
                            <input style="width: 500px;" class="input-field" type="text" placeholder="Username" name="username" id="username">
                            <i id="i_username" ></i>
