                ...
                <div class="modal_content">
                    <div class="modal_curri_input_container">
                        <div class="modal_curri_input">
                            ...
                            <input type="varchar" maxlength="10" class="input_field" name="progCode" id="progCode" placeholder="Please Enter Course Code">
                            <i class="fa-solid fa-asterisk"></i>
                            <i id="i_pcAdd" class="fa-solid "></i>
                        </div>
                        <div class="modal_curri_input">
                            <p class="label">Description: </p>
                            <input type="text" maxlength="70" class="input_field" name="progDescription" id="progDescription"  placeholder="Please Enter Code Description">
                            <i class="fa-solid fa-asterisk"></i>
