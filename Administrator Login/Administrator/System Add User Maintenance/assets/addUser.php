                    ...
                    if($query_run){
                        ...
                        while($details = mysqli_fetch_assoc($sql_fetch))
                        {
                            ...
                            Your password is: <u>".$passgen."</u></a>
                                ...
                                $mail->SMTPAuth = true;
                                $mail->Username = "jimwellaluquin03@gmail.com"; // Your Gmail account
                                $mail->Password = "cxyscdyjprmsiiwy"; // Your Gmail account password
                                $mail->SMTPSecure = "tls";
                                $mail->Port = 587;
                                $mail->From = "jimwellaluquin03@gmail.com"; // Your Gmail account
