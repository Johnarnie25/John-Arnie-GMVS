        ...
        <div class="subcontent">
            ...
            <form id="addRole" method="POST">
                <div class="input_group">
                    ...
                    <div class="input_container">
                        <label for="studCouncheck" class="labelcheck">Student Counseling</label>
                        <select class="input_fieldselectAdd" name="studCouncheck" id="studCouncheck">
                            <option value='' disabled selected>Status</option>
                            <?php 
                            $statuscheck = mysqli_query($connection, "SELECT StatusID, StatusDescription FROM `statuscontent`");
                            while($row3 = mysqli_fetch_assoc($statuscheck)){
                                $statsID = $row3['StatusID']; 
                                $statsName = $row3['StatusDescription'];
                            ?>
                ...
                <div class="action_content">
                    <button class="bttn" type="submit" name="submit" id="submitRole">
                        <i class="fa-solid fa-check-to-slot"></i> Add Role
                    </button>
                </div>
            </form>
            ...
            <div class="list" id="tableRoles">
                ...
                <table class="display">
                    <tr> 
                        ...
                        <th class="table_title" style="width: 15%;">Student Counseling</th>
                    ...
                    <?php
                    $userRole = $connection->query("SELECT * FROM adminuserrole");
                    while($row = $userRole->fetch_assoc()){
                        $id = $row['AdminUserRoleID']; 
                        $roleName = $row['AdminUserRole']; 
                        $studentCounc = $row['AdminPageStudentCounceling']; 
                        $studentViolation = $row['AdminPageViolation'];
                        $sysMain = $row['AdminMaintenance']; 
                        $status = $row['StatusID'];
                    ?>
                    <tr>
                        ...
                        <td class="data"><a href="../System Edit User Role Maintenance/?role_id=<?php echo $id ?>" class="bttn_table"><i class="fa-solid fa-user-pen"></i> Edit</a></td>
                    </tr>
                    <?php
                    }
                    ?>
...
<div class="alert " id="alert_bottomappointment">
    <div class="alert_content">
        <div class="alert_content_text" id="alert_contentappointment"></div>
