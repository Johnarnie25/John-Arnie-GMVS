                ...
                <div class="sub_content">
                        ...
                        <div class="input_group">
                            <div class="input_container">
                                ...
                                <div class="input " id="input_fname">
                                    <input type="text" class="input-field" maxlength="50" name="email" id="email" value="<?php echo $email?>">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_mname">
                                    <input type="text" class="input-field" maxlength="11" name="cNom" id="cNom" value="<?php echo $cNom?>">
                        ...
                        <div class="input_group">
                            <div class="input_container">
                                ...
                                <div class="input " id="input_lname">
                                    <input type="text" class="input-field" maxlength="40" name="cguard" id="cguard" value="<?php echo $cguard?>">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_suffname">
                                    <input type="text" class="input-field" maxlength="11" name="cguardNum" id="cguardNum" value="<?php echo $cguardNum?>">
                        ...
                        <div class="input_group">
                            <div class="input_container add">
                                ...
                                <div class="input " id="input_stud_num">
                                    <input type="text" class="input-field" maxlength="70" name="add" id="add" value="<?php echo $add?>">
