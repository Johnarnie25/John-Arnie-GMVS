            ...
            <!--<form>-->
                ...
                <div class="modal_content">
                    <div class="modal_add_violation">
                        ...
                        <input type="text" maxlength="80" class="input_field" id="violations" name="violations" >
                ...
                <div class="modal_content">
                    <div class="modal_add_sanction">
                        <div class="sanction_input">
                            ...
                            <input type="text" maxlength="40" class="input_field" id="sanctions" name="sanctions" >
                            <i class="fa-solid fa-asterisk"></i>
