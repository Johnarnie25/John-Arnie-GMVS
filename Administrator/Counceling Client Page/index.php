...
if ($conn->connect_error){
    ...
    WHERE anonymity = 'No' AND stat = 'To be Evaluate' AND remarks = '$name'");
    ...
    WHERE anonymity = 'Yes' AND stat = 'To be Evaluate' AND remarks = '$name'");
    ...
    if(isset($_POST['submit'])){
        ...
        WHERE stat = 'To be Evaluate' AND anonymity = 'No' AND remarks = '$name'
