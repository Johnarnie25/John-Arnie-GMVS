...
<div class="body_container">
    <div class="content">
        ...
        <tr> 
            ...
            <th class="violation_title" style="width: 50px;">Delete</th>
        </tr>
        ...
        <tr>
            ...
            <td class="violation_data">
                <a href="assets/delete_entry.php?entry_id=<?php echo $row['entry_id']; ?>" class="deleteBttn" style="text-decoration: none; color: #45B39D; background: none; border: none; padding: 0; margin: 0;" onclick="return confirm('Are you sure you want to delete this entry?');">
