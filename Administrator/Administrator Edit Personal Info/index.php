                        ...
                        <div class="input_group">
                            <div class="input_container">
                                ...
                                <div class="input " id="input_fname">
                                    <input type="text" class="input-field" maxlength="15" name="fname" id="fname" value="<?php echo $fname?>">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_mname">
                                    <input type="text" class="input-field" maxlength="12" name="mname" id="mname" value="<?php echo $mname?>">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_lname">
                                    <input type="text" class="input-field" maxlength="15" name="lname" id="lname" value="<?php echo $lname?>">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_suffname">
                                    <input type="text" class="input-field" maxlength="10" name="suffname" id="suffname" value="<?php echo $sname?>">
                        ...
                        <div class="input_group">
                            <div class="input_container">
                                ...
                                <div class="input " id="input_aNo">
                                    <input type="text" class="input-field" maxlength="11" name="aNo" id="aNo" value="<?php echo $aNo?>">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_aEmail">
                                    <input type="text" class="input-field" maxlength="45" name="aEmail" id="aEmail" value="<?php echo $aEmail?>">
                            ...
                            <div class="input_container add">
                                ...
                                <div class="input " id="input_aAdd">
                                    <input type="text" class="input-field" maxlength="60" name="aAdd" id="aAdd" value="<?php echo $aAdd?>">
