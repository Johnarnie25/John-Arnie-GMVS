                    ...
                    <div class="input_group">
                            <div class="input_container">
                                ...
                                <div class="input " id="input_fst_name">
                                    <input class="input-field" type="text" placeholder="Ex: 00-0000-00000" name="studNum" id="studNum">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_mid_name">
                                    <input class="input-field" type="text" maxlength="15"placeholder="Ex: quipo" name="lastName" id="lastName">
                                    <i class="fa-solid fa-asterisk"></i>
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_last_name">
                                    <input class="input-field" type="text" maxlength="15"placeholder="Ex: tanggol" name="firstName" id="firstName">
                                    <i class="fa-solid fa-asterisk"></i>
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_suf_name">
                                    <input class="input-field" type="text" maxlength="12" placeholder="Ex: probinsayano. (If None, Type None)" name="middleName" id="middleName">
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_admin_email">
                                    <input class="input-field" type="text" maxlength="8" placeholder="Ex: 1" name="Section" id="Section">
                                    <i class="fa-solid fa-asterisk"></i>
                            ...
                            <div class="input_container">
                                ...
                                <div class="input " id="input_username">
                                    <input class="input-field" type="text" maxlength="70" placeholder="Ex: kuyapo" name="Addres" id="Addres">
                                    <i class="fa-solid fa-asterisk"></i>
