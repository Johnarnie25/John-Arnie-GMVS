                    ...
                    <div class="input_group">
                        <div class="input_container">
                            ...
                            <div class="input " id="input_fst_name">
                                <input class="input-field" type="text"maxlength="15"  placeholder="Ex: Tangol" name="fst_name" id="fst_name">
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_mid_name">
                                <input class="input-field" type="text" maxlength="12"placeholder="Leave if None" name="mid_name" id="mid_name">
                                <i id="i_mid_name" ></i>
                            </div>
                        </div>
                        <div class="input_container">
                            ...
                            <div class="input " id="input_last_name">
                                <input class="input-field" type="text" maxlength="15" placeholder="Ex: Unli Bala" name="last_name" id="last_name">
                                <i class="fa-solid fa-asterisk"></i>
                                <i id="i_last_name" ></i>
                            </div>
                        </div>
                        <div class="input_container">
                            ...
                            <div class="input " id="input_suf_name">
                                <input class="input-field" type="text" maxlength="3" placeholder="Ex: Jr. (Leave if None)" name="suf_name" id="suf_name">
                                <i id="i_suf_name" ></i>
                            </div>
                        </div>
                       ...
                       <div class="input_container">
                            ...
                            <div class="input " id="input_stud_num">
                                <input class="input-field" type="text" maxlength="14" placeholder="Ex : 00-3031-01199" name="stud_num" id="stud_num">
                                <i class="fa-solid fa-asterisk"></i>
                                <i id="i_stud_num"></i>
                            </div>
                        </div>
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_client_email">
                                <input class="input-field" type="text" maxlength="50" placeholder="Ex: Tangollangmalakas@gmail.com" name="client_email" id="client_email">
                                <i class="fa-solid fa-asterisk"></i>
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_password">
                                <input class="input-field" type="password" maxlength="30" placeholder="Password" name="password" id="password">
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_cpassword">
                                <input class="input-field" type="password" maxlength="30"placeholder="Confirm Password" name="cpassword" id="cpassword">
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_add">
                                <input class="input-field " type="" maxlength="70" placeholder="Address" name="add" id="add">
                                <i class="fa-solid fa-asterisk"></i>
                                <i id="i_add" ></i>
                            </div>
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_client_contact">
                                <input class="input-field" type="text" maxlength="11" placeholder="Ex: 09*********" name="client_contact" id="client_contact">
                                <i class="fa-solid fa-asterisk"></i>
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_guar_name">
                                <input class="input-field" type="text" maxlength="40" placeholder="Guardian's Name" name="guar_name" id="guar_name">
                                <i class="fa-solid fa-asterisk"></i>
                                <i id="i_guar_name" ></i>
                            </div>
                        </div>
                        <div class="input_container">
                            ...
                            <div class="input " id="input_guardian_contact">
                                <input class="input-field" type="text" maxlength="11" placeholder="Ex: 09*********" name="guardian_contact" id="guardian_contact">
                                <i class="fa-solid fa-asterisk"></i>
