...
$sql_fetch = mysqli_query($connection, "SELECT ClientFirstName, ClientMiddleName, ClientLastName, ClientSuffix, ClientStudentNo
     FROM clientaccountinfo WHERE ClientAccountID = '$id'");
$name = "";
while ($row = mysqli_fetch_assoc($sql_fetch)) {
    $name = $row['ClientFirstName'];
    $fname = $row['ClientFirstName'];
    $mname = $row['ClientMiddleName'];
    $lname = $row['ClientLastName'];
    $sname = $row['ClientSuffix'];
    $stud_ID = $row['ClientStudentNo'];
}

$sql_fetchpic = mysqli_query($connection, "SELECT PictureFilename FROM clientprofilepictureinfo WHERE ClientAccountID = '$id' AND UsedStatus = TRUE");
